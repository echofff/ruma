...
pub mod v1 {
    ...
    use ruma_common::{api::ruma_api, events::AnyRoomEvent, identifiers::TransactionId};
    use ruma_serde::Raw;
    ...
    impl IncomingRequest {
        ...
        pub fn try_into_sync_response(
            ...
            use ruma_common::identifiers::RoomId;
    ...
    mod helper_tests {
        use ruma_client_api::sync::sync_events;
        use ruma_common::{identifiers::TransactionId, room_id};
