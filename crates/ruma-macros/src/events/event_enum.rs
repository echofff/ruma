    ...
    quote! {
        ...
        impl #ident {
            ...
            pub fn into_full_event(
                self,
                room_id: ::std::boxed::Box<#ruma_common::identifiers::RoomId>,
            ) -> #full {
                match self {
                    #(
                        #self_variants(event) => {
    ...
    quote! {
        ...
        impl #ruma_common::events::Redact for #ident {
            ...
            fn redact(
                ...
                version: &#ruma_common::identifiers::RoomVersionId,
            ) -> #redacted_enum {
                match self {
                    #(
...
fn field_return_type(
    ...
    match name {
        ...
        "room_id" => quote! { #ruma_common::identifiers::RoomId },
        "event_id" => quote! { #ruma_common::identifiers::EventId },
        "sender" => quote! { #ruma_common::identifiers::UserId },
